...
export default async function EventDetailPage({
  ...
  // Fetch related events (upcoming events from same source or any upcoming)
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap items-center gap-3 mb-4">
                  {status === 'live' && (
                    <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-green-500 text-white text-sm font-semibold shadow-lg shadow-green-500/30">
                ...
                <div className="flex flex-wrap gap-3 mt-8">
                  {event.url && (
                    <Link
                      ...
                      className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white text-emerald-700 font-semibold hover:bg-white/90 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                    >
                  ...
                  {event.tickets_url && (
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-emerald-800 text-white font-semibold hover:bg-emerald-900 transition-all border border-white/20"
                    >
                      <Ticket size={18} />
                      Get Tickets
                    </Link>
              ...
              <div className="space-y-3">
                {event.url && (
                  <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-between w-full px-4 py-3 rounded-xl bg-[var(--brand)]/10 text-[var(--brand)] font-medium hover:bg-[var(--brand)]/20 transition-colors group"
                  >
                ...
                {event.tickets_url && (
                  <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-between w-full px-4 py-3 rounded-xl bg-emerald-600 text-white font-medium hover:bg-emerald-700 transition-colors group"
                  >
                    <span className="flex items-center gap-2">
                      <Ticket size={18} />
                      Get Tickets
              ...
              <div className="bg-[var(--surface)] rounded-2xl border border-[var(--border)] p-6 shadow-sm">
                ...
                <div className="space-y-3">
                  {relatedEvents.map((relatedEvent) => (
                    <Link
                      key={relatedEvent.id}
                      href={`/esg/events/${relatedEvent.id}`}
                      className="block p-3 rounded-xl hover:bg-[var(--surface-2)] transition-colors group"
                    >
                      <h4 className="font-medium text-[var(--text)] line-clamp-2 group-hover:text-[var(--brand)] transition-colors">
                        {relatedEvent.title}
                      </h4>
