...
export default async function TendersPage({
  ...
  const title = domain === 'esg' ? 'ESG Tenders' : 'Credit Tenders';
  const description = domain === 'esg' 
    ? 'Browse government tenders related to ESG, sustainability, and environmental projects.'
    : 'Explore credit-related tenders, financial instruments, and risk management opportunities.';
